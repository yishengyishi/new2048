...
var margin = 0.025 * documentWidth;
var game_width = 0.60 * documentWidth;
var box_width = 0.12 * documentWidth;
...
function drawBox(cxt, i, j, nums){
    ...
    context.translate(x + box_width/2 , y+box_width/2 );
    context.rotate(-45*Math.PI/180);
